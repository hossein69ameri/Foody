...
import com.example.nourifoodapp1.utils.RecipesDiffUtil
import com.example.nourifoodapp1.viewmodel.FavoriteViewModel
import com.google.android.material.snackbar.Snackbar

class FavoriteRecipesAdapter(private val requireActivity: FragmentActivity, private val favoriteViewModel: FavoriteViewModel
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.favoriteRecipesRowLayout.setOnClickListener {
            if (multiSelection) {
                ...
                val action =
                    FavoriteFragmentDirections.actionFavoriteRecipesFragmentToDetailActivity(
    ...
    override fun onActionItemClicked(actionMode: ActionMode?, menu: MenuItem?): Boolean {
        if (menu?.itemId == R.id.delete_favorite_recipe_menu) {
            selectedRecipes.forEach {
                favoriteViewModel.deleteFavoriteRecipe(it)
            }
