...
import com.example.nourifoodapp1.ui.fragment.favorite.FavoriteRecipesAdapter
...
class FavoriteRecipesBinding {
    ...
    companion object {
        ...
        @JvmStatic
        fun setVisibility(view: View, favoritesEntity: List<FavoriteEntity>?, mAdapter: FavoriteRecipesAdapter?) {
            when (view) {
                is RecyclerView -> {
